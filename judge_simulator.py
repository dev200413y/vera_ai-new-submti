...
BOT_URL = "https://vera-bot-740244290914.asia-south1.run.app"

# Choose your LLM provider: "openai", "anthropic", "gemini", "deepseek", "groq", "ollama", "openrouter"
# Choose your LLM provider
LLM_PROVIDER = "ollama"
LLM_API_KEY = ""  # Ollama doesn't need an API key
LLM_MODEL = "llama3" # or "mistral"
OLLAMA_URL = "http://localhost:11434" # Aapko ise bas add karna hoga agar code maange
